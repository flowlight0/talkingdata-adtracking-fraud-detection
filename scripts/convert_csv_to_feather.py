...
df_old_test = pd.read_csv(os.path.join(data_dir, 'test_supplement.csv'), dtype=dtypes, usecols=test_columns, parse_dates=test_parse_dates)
df_old_test = df_old_test[df_old_test.click_time >= df_train.click_time[len(df_train) - 1]]
